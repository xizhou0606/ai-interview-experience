...
export function Footer() {
  return (
    <footer className="site-footer">
      ...
      <div><span>内容</span><button onClick={() => navigateTo('#roadmap')}>学习路线</button><button onClick={() => navigateTo('#news')}>技术新闻</button><button onClick={() => navigateTo('#technologies')}>技术栈百科</button><button onClick={() => navigateTo('#apis')}>框架官方 API</button><button onClick={() => navigateTo('#projects')}>项目证据</button></div>
