...
export function Footer() {
  return (
    <footer className="site-footer">
      ...
      <div><span>方法</span><button onClick={() => navigateTo('#patterns')}>工程模式</button><button onClick={() => navigateTo('#news')}>技术新闻</button><button onClick={() => navigateTo('#sources')}>资料与可信度</button></div>
