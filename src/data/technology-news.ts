...
export const technologyNews: TechnologyNewsItem[] = [
  {
    ...
    time: '09:55',
    category: 'AI',
    title: 'Codex 发布 0.151 稳定版',
    summary: '官方 CLI 与 SDK 稳定发布，对齐近期智能体循环与各平台二进制更新。',
  ...
  },
  {
    date: '2026-08-28',
    category: 'AI',
    title: 'OpenAI 开放 Rosalind 科研工作台',
    summary: 'ChatGPT 中预览生命科学工作台，可串联结构查看、测序分析与实验规划。',
  ...
  },
  {
    ...
    summary: '770B/49B MoE、超 1M 上下文，面向编程、办公与科研，可经 TokenHub 调用。',
    source: 'Tencent',
  ...
  },
  {
    date: '2026-08-28',
    category: 'AI',
    title: '开放 ASR 首次纳入印地语',
    summary: 'Open ASR 排行榜加入首个全球南方语言，用印地语评测开源语音识别。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    summary: '云端 GA，用智能体推理查找越权与业务逻辑漏洞，并在报告前验证可利用性。',
    source: 'SonarSource',
  ...
  },
  {
    ...
    category: 'AI',
    title: '多向量编码器微调指南发布',
    summary: 'Sentence Transformers 文档讲解 ColBERT 风格多向量模型的训练与微调。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-26',
    category: 'AI',
    title: '智谱开源GLM-5.3-Flash多模态',
    summary: '320B/18B原生多模态MoE，1M上下文，MIT开源权重，编码接近Opus 4.8。',
    source: 'Z.ai',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'IBM 开源 Granite Speech 5.0',
    summary: '470M TurboCTC 英语转写，H200 上超 12600 倍实时率，提供 Apache 与非商用版。',
    source: 'IBM Granite',
  ...
  },
  {
    date: '2026-08-25',
    category: '后端',
    title: 'Vercel 发布 Run SDK 安全求值',
    summary: '在应用内执行不可信 JS/TS，用宿主函数隔离，并支持中断审批后继续。',
    source: 'Vercel Blog',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Meta 开放 Muse Image 开发者 API',
    summary: '官方 Model API 可生成、编辑与组合图像，按张计费，支持锚定构图。',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Chat SDK 现已支持 XChat',
    summary: '同一套 Chat SDK 处理器可接入 XChat，把智能体带到该聊天平台。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-24',
    category: '后端',
    title: '环境变量改用 Config 与 Secret',
    summary: 'Vercel 环境变量分为配置与密钥两类，避免把密钥当普通配置暴露。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-24',
    category: '后端',
    title: 'Bun 运行时支持大函数与长时限',
    summary: 'Vercel 上 Bun 函数可处理更大体积并延长最长执行时间。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    time: '04:58',
    category: '前端',
    title: 'create-vite 9.2 支持 nub 包管理器',
    summary: '脚手架新增 nub，并更新依赖、React Compiler 说明与 oxfmt 配置。',
    source: 'Vite GitHub',
  ...
  },
  {
    date: '2026-08-24',
    category: 'AI',
    title: 'Gradio 发布工作流编排指南',
    summary: '官方教程讲如何在 Gradio 中串联、运行并部署 AI 工作流。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-21',
    category: 'AI',
    title: 'Claude Mythos 5 向更多防御者开放',
    summary: '把 Mythos 5 网络安全能力扩展给更多安全团队用于防御场景。',
    source: 'Claude Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: 'AI',
    title: 'Vercel Agent Slack 集成公开测试',
    summary: '在 Slack 里 @Vercel 可排查事故、审 PR 并提交待批准变更，面向 Pro/企业。',
    source: 'Vercel Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: '后端',
    title: 'Vercel Python Queues SDK 进测试',
    summary: 'Python 项目可用官方 Queues SDK 投递与处理后台任务，现为公测。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    time: '13:46',
    category: 'AI',
    title: 'Sentence Transformers 发布 v6',
    summary: '新增 MultiVectorEncoder，支持 ColBERT 式多向量检索，并升到 transformers v5。',
  ...
  },
  {
    ...
    summary: 'Vercel 函数可经 KMS 签名 JWT，不必再自行保管私钥。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-17',
    category: 'AI',
    title: 'Azure 托管 Claude 新增五能力',
    summary: 'Foundry 上 Azure 托管 Claude 现支持结构化输出、网页搜索抓取、MCP 与工具搜索。',
