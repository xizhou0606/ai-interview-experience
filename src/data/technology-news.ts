...
export const technologyNews: TechnologyNewsItem[] = [
  {
    ...
    time: '11:25',
    category: '前端',
    title: 'Vite 8.3.0 提升构建与代理性能',
    summary: '构建时跳过已见预加载依赖结算，代理匹配器启动即预编译，并修正依赖路径与 CRLF 行号。',
    source: 'Vite GitHub',
  ...
  },
  {
    ...
    time: '14:00',
    category: 'AI',
    title: 'DeepMind 发布基因组变异图谱',
    summary: 'AlphaGenome Atlas 预计算约 90 亿单碱基变异效应，并提供 AVI 评分与学术研究门户。',
  ...
  },
  {
    ...
    time: '11:30',
    category: 'AI',
    title: 'OpenAI 发布 ChatGPT Images 2.5',
    summary: '图像生成更快、编辑更准，支持草图出图与模板，并改进信息图版式与细节保留。',
    source: 'OpenAI',
  ...
  },
  {
    ...
    summary: '全球天气模型接入实时卫星，每小时刷新，分辨率最高 5 公里，并已接入搜索与地图。',
    source: 'Google DeepMind',
  ...
  },
  {
    date: '2026-09-03',
    category: 'AI',
    title: 'Cursor 云智能体可跑 Vercel 沙箱',
    summary: '企业可用自托管机器接口，把仓库克隆与命令执行放到隔离的 Vercel 微虚拟机。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-31',
    category: 'AI',
    title: 'AI SDK Harness 接入 fx 智能体',
    summary: '官方适配器让应用用同一 Harness 接口接入 Vercel 开源编码智能体 fx。',
    source: 'Vercel Changelog',
