...
export const technologyNews: TechnologyNewsItem[] = [
  { date: '2026-09-11', time: '06:00', category: '后端', title: 'Sandbox 存储扩至 64GB', summary: '每个沙箱默认存储从 32GB 升至 64GB，便于大仓库与构建产物落盘。', source: 'Vercel', url: 'https://vercel.com/changelog/vercel-sandbox-64-gb-storage' },
  { date: '2026-09-10', time: '19:51', category: 'AI', title: 'Codex Python SDK 0.154 发布', summary: 'Python SDK 对齐 CLI 0.154，新增 max/ultra 推理档与外部消息接口。', source: 'GitHub', url: 'https://github.com/openai/codex/releases/tag/python-v0.154.0' },
  { date: '2026-09-10', category: 'AI', title: 'Copilot 接入 AI SDK Harness', summary: 'AI SDK harness 层新增 Copilot 适配器，可用同一套 HarnessAgent 切换编码智能体。', source: 'Vercel', url: 'https://vercel.com/changelog/github-copilot-ai-sdk-harness-adapter' },
  { date: '2026-09-10', category: 'AI', title: 'Vercel 接入 OpenAI Agents API', summary: 'OpenAI 托管智能体循环，Queues 处理签名 webhook，Sandbox 提供隔离持久执行环境。', source: 'Vercel', url: 'https://vercel.com/changelog/build-with-openai-agents-api-on-vercel' },
  { date: '2026-09-10', category: 'AI', title: 'Anthropic 发布九月威胁情报', summary: '披露近八月恶意使用 Claude 的案例，覆盖网络、欺诈与武器研制等七类危害。', source: 'Anthropic', url: 'https://www.anthropic.com/threat-intelligence-report-september-2026' },
  { date: '2026-09-10', category: 'AI', title: 'Anthropic 评测瞄准与武器能力', summary: '红队发布战术瞄准与常规武器研制评测，显示开源与前沿模型均有相关能力。', source: 'Anthropic', url: 'https://www.anthropic.com/research/intelligence-targeting-conventional-weapons-capabilities' },
  { date: '2026-09-10', category: 'AI', title: 'GPT-Live-1 登陆开发者 API', summary: '全双工语音模型进 API，可边听边说并委托推理，按分钟计前端语音层。', source: 'OpenAI', url: 'https://openai.com/index/introducing-gpt-live-1-in-the-api/' },
  { date: '2026-09-10', category: 'AI', title: 'ChatGPT Work 上线数据智能体', summary: '企业数据可连入问答与交互看板，无需写查询即可分析并分享结论。', source: 'OpenAI', url: 'https://openai.com/index/put-data-to-work/' },
  { date: '2026-09-10', category: '后端', title: 'FastAPI 前端静态文件走 CDN', summary: '构建时把 FastAPI 前端与静态文件提升到 CDN，请求不再经过函数。', source: 'Vercel', url: 'https://vercel.com/changelog/fastapi-frontends-and-static-files-served-from-the-cdn' },
  ...
  { date: '2026-09-08', category: '后端', title: 'Python Workers 默认升至 3.14', summary: '兼容日期 2026-09-08 起的新 Worker 默认 3.14，底层为 Pyodide 314.0.6。', source: 'Cloudflare', url: 'https://developers.cloudflare.com/changelog/post/2026-09-08-python-workers-314/' },
  ...
  { date: '2026-09-04', category: '后端', title: 'Workers 部署上限提至 64MiB', summary: '取消压缩体积限制，全套餐只按未压缩包体 64MiB 计，便于部署更大依赖。', source: 'Cloudflare', url: 'https://developers.cloudflare.com/changelog/post/2026-09-04-increased-worker-size-limit/' },
  { date: '2026-09-04', category: '后端', title: 'R2 访问日志正式可用', summary: '可为存储桶记录读写列表与删除等成功操作，并在 Workers Observability 中筛选。', source: 'Cloudflare', url: 'https://developers.cloudflare.com/changelog/post/2026-09-04-r2-data-access-logs/' },
  ...
  { date: '2026-09-03', category: 'AI', title: 'Hugging Face 发布 funes', summary: '把编码智能体会话编成可检索记忆，跨工具与机器复用决策依据。', source: 'Hugging Face', url: 'https://huggingface.co/blog/funes' },
  ...
  { date: '2026-09-02', category: '后端', title: 'Python Workers 可接 WSGI 框架', summary: '可用 wsgi/asgi 入口接入 Django、Flask、FastAPI，不必自写适配层。', source: 'Cloudflare', url: 'https://developers.cloudflare.com/changelog/post/2026-09-02-python-workers-web-framework-support/' },
  ...
  { date: '2026-09-01', category: 'AI', title: 'Google 发布甲烷卫星检测模型', summary: '用深度学习从 EMIT 卫星数据自动检测甲烷羽流，并公开全球数据库。', source: 'Google Research', url: 'https://research.google/blog/mapping-global-methane-emissions-from-space-with-deep-learning/' },
  ...
  { date: '2026-08-31', category: '后端', title: 'Cloudflare 上线自适应机器人检测', summary: '新检测引擎持续重训并生成一次性规则，提高机器人攻击成本。', source: 'Cloudflare', url: 'https://blog.cloudflare.com/introducing-adaptive-intelligence/' },
