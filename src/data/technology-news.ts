...
export const technologyNews: TechnologyNewsItem[] = [
  {
    ...
    time: '09:55',
    category: 'AI',
    title: 'Codex 0.151强化MCP与工具路由',
    summary: '稳定版可配置MCP启动宽限，扩展能处理工具结果，并按仓库加载插件配置。',
  ...
  },
  {
    date: '2026-08-28',
    category: 'AI',
    title: 'OpenAI开放Rosalind科研工作台',
    summary: 'ChatGPT内可做结构查看与测序分析，把问题、工具和证据连在同一工作流。',
  ...
  },
  {
    ...
    summary: '770B总参、49B激活、超1M上下文，面向编程、办公与科研，并开放权重与API。',
    source: 'Tencent',
  ...
  },
  {
    ...
    category: 'AI',
    title: '开放ASR榜新增印地语评测',
    summary: '全球南方首个官方语言加入公开转写榜，先评印地语短音频。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-27',
    category: 'AI',
    title: 'SonarQube猎人智能体正式可用',
    summary: '云端GA后可用智能体推理访问控制与业务逻辑漏洞，确认可利用后再入库。',
    source: 'Sonar',
  ...
  },
  {
    date: '2026-08-26',
    category: 'AI',
    title: 'Meta开放Muse Image开发者API',
    summary: '可直接调用生成、编辑与构图接口，先规划版面再出图，单价约1美分。',
  ...
  },
  {
    ...
    summary: '470M英语转写模型可超12600倍速推理，提供Apache与非商用两个许可版本。',
    source: 'IBM Granite',
  ...
  },
  {
    ...
    summary: '在QuickJS中执行不可信JS/TS，只暴露宿主函数，并可中断等人审批后继续。',
    source: 'Vercel Blog',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Gradio可用工作流编排AI步骤',
    summary: 'gr.Workflow把节点图画成可运行画布，并生成REST接口，一键部署到Spaces。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    category: 'AI',
    title: '多向量编码器微调指南发布',
    summary: '官方讲解如何用Sentence Transformers训练和微调ColBERT式多向量模型。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Chat SDK现已支持XChat',
    summary: '同一套Chat SDK机器人可接入X的加密消息产品XChat。',
  ...
  },
  {
    ...
    summary: '脚手架可识别nub，并更新React插件文档链接与依赖。',
    source: 'Vite GitHub',
  ...
  },
  {
    date: '2026-08-24',
    category: '后端',
    title: '环境变量拆成Config与Secret',
    summary: '控制台和CLI可把变量标为可读配置或写入后不可读的密钥。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    summary: 'Bun运行时可把函数包扩到5GB，最长执行时间延长到30分钟。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-21',
    category: 'AI',
    title: 'Claude Mythos 5面向更多防守方',
    summary: '把网络安全能力扩展到更多防御团队，用于威胁研判与漏洞核查。',
    source: 'Claude Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: 'AI',
    title: 'Vercel Agent进Slack公开测试',
    summary: '在频道里@Vercel即可查日志、排障并提交需审批的修复计划。',
    source: 'Vercel Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: '后端',
    title: 'Vercel Python队列SDK进入测试',
    summary: '可用Python投递和消费队列，并与Next.js生产者跨运行时互发消息。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    time: '13:46',
    category: 'AI',
    title: 'Sentence Transformers发布v6',
    summary: '新增MultiVectorEncoder支持ColBERT式多向量检索，并升到transformers v5。',
  ...
  },
  {
    date: '2026-08-18',
    category: '后端',
    title: '函数可用KMS签发JWT无需私钥',
    summary: '用托管非对称密钥签名，私钥不进代码或环境变量，校验证走公开JWKS。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-17',
    category: 'AI',
    title: 'Azure托管Claude新增五项能力',
    summary: 'Azure上的Claude现支持结构化输出、联网搜索、抓取、MCP连接与工具检索。',
