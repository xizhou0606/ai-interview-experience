...
export const technologyNews: TechnologyNewsItem[] = [
  { date: '2026-09-11', time: '06:00', category: '后端', title: 'Vercel 沙箱存储扩至 64GB', summary: '每个沙箱磁盘从 32GB 提到 64GB，覆盖托管镜像、自定义镜像与旧 runtime。', source: 'Vercel', url: 'https://vercel.com/changelog/vercel-sandbox-64-gb-storage' },
  { date: '2026-09-10', time: '17:00', category: '后端', title: 'FastAPI 前端静态文件改走 CDN', summary: '构建时把 FastAPI 前端与静态文件提升到 CDN，请求不再进入函数。', source: 'Vercel', url: 'https://vercel.com/changelog/fastapi-frontends-and-static-files-served-from-the-cdn' },
