...
export const technologyNews: TechnologyNewsItem[] = [
  {
    ...
    summary: '稳定版补可选 MCP 发现宽限期，并修远程沙箱、权限配置与子智能体额度统计。',
    source: 'Codex GitHub',
  ...
  },
  {
    date: '2026-08-28',
    category: 'AI',
    title: 'OpenAI 发布 Rosalind 科研台',
    summary: '科研工作台用引导任务、科学查看器与测序分析，帮研究者从数据走到证据。',
  ...
  },
  {
    ...
    category: 'AI',
    title: '开放ASR榜首增印地语评测',
    summary: 'Open ASR 排行榜首次加入全球南方语言印地语，公开转写模型对照结果。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    summary: '770B总参、49B激活、超百万上下文，面向编程办公与科研，并开放权重与API。',
    source: 'Tencent',
  ...
  },
  {
    ...
    summary: '云端GA可用AI代理查找访问控制与业务逻辑漏洞，发现后先验证可利用性再入库。',
    source: 'SonarSource',
  ...
  },
  {
    date: '2026-08-26',
    category: 'AI',
    title: '智谱发布 GLM-5.3-Flash',
    summary: '首个原生多模态Flash模型，320B总参仅18B激活，编码与智能体接近旗舰价更低。',
    source: 'Z.ai',
  ...
  },
  {
    ...
    category: 'AI',
    title: '多向量编码器微调指南发布',
    summary: 'Sentence Transformers 给出 ColBERT 风格多向量模型的微调、损失与评测完整流程。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Chat SDK 支持 XChat 加密会话',
    summary: '新适配器可建端到端加密的一对一与群聊机器人，自动处理密钥与签名校验。',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'IBM开源Granite Speech 5.0',
    summary: '470M英语转写模型批量吞吐超12600 RTFx，提供Apache与非商用两个许可版本。',
    source: 'IBM Granite',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Vercel 发布 Run SDK 沙箱',
    summary: '在隔离 QuickJS 中执行不可信 TS/JS，可用宿主函数中断审批后再续跑。',
    source: 'Vercel Blog',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Meta 开放 Muse Image 开发者API',
    summary: '开发者可用 Meta Model API 做生图、编辑与组合，定价每张 0.01 美元。',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Gradio 工作流可拖拽部署',
    summary: 'gr.Workflow 把流水线做成可运行画布，节点可调、中间结果可见，并导出 REST。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    time: '04:58',
    category: '前端',
    title: 'create-vite 9.2 支持 nub 包管理',
    summary: '脚手架新增 nub 包管理器，并更新依赖与 React Compiler 实验说明。',
    source: 'Vite GitHub',
  ...
  },
  {
    ...
    category: '后端',
    title: '环境变量改为配置与密钥',
    summary: 'Vercel 用 Config/Secret 取代 Sensitive 开关，密钥保存后不可回看，CLI可指定类型。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-24',
    category: '后端',
    title: 'Bun 运行时支持大函数长时',
    summary: 'Vercel 上 Bun 函数可到 5GB 包与 30 分钟，此前仅 Node 与 Python 可用。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-21',
    category: 'AI',
    title: 'Claude Mythos 5 开放给更多防御方',
    summary: 'Anthropic 把网络安全模型 Mythos 5 能力扩展到更多安全团队与防御场景。',
    source: 'Claude Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: '后端',
    title: 'Vercel Python Queues SDK 公测',
    summary: 'Python 可发布与消费队列消息，并与 JavaScript 生产者或消费者跨运行时协作。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-19',
    category: 'AI',
    title: 'Vercel Agent Slack 公测上线',
    summary: 'Pro/Enterprise 可在 Slack 提及 Agent 查日志部署并提修复，改动需先批准计划。',
    source: 'Vercel Blog',
  ...
  },
  {
    ...
    time: '13:46',
    category: 'AI',
    title: 'Sentence Transformers 6.0 发布',
    summary: '新增多向量编码器，依赖升至 transformers v5，并加快训练编码、修正半精度计分。',
  ...
  },
  {
    date: '2026-08-18',
    category: '后端',
    title: 'Vercel KMS 可代签函数 JWT',
    summary: '函数用托管非对称密钥签 JWT，私钥不进代码或环境变量，公钥可走标准 OIDC 校验。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-17',
    category: 'AI',
    title: 'Azure托管Claude增五项能力',
    summary: 'Foundry上Azure托管Claude现支持结构化输出、网页搜索抓取、MCP与工具检索。',
