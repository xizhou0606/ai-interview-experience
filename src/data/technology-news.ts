...
export const technologyNews: TechnologyNewsItem[] = [
  {
    ...
    time: '16:29',
    category: '后端',
    title: 'Kubernetes 1.37 含67项增强',
    summary: '官方发布 Garhwal：KYAML 与指标 API 转稳定，HPA 默认可缩到零副本。',
    source: 'Kubernetes',
  ...
  },
  {
    ...
    time: '15:13',
    category: '后端',
    title: 'pnpm 12 用 Rust 重写并稳定',
    summary: 'Rust 重写保持命令与锁文件兼容，并新增项目感知全局 bin。',
    source: 'pnpm',
  ...
  },
  {
    ...
    summary: '首个原生多模态 Flash 型号，3200 亿总参仅激活 180 亿，编程与智能体接近旗舰。',
    source: 'Z.ai',
  ...
  },
  {
    ...
    category: 'AI',
    title: '多向量编码器微调指南发布',
    summary: '指南讲解如何用 MultiVectorEncoder 微调 ColBERT 风格检索模型。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    summary: '470M TurboCTC 英语转写模型，H200 上超 12600 倍实时，并提供 Apache 授权版。',
    source: 'IBM Granite',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Gradio 工作流可编排模型图',
    summary: 'gr.Workflow 把步骤做成可运行画布，中间结果可见，同一图可当 REST 部署。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Muse Image 对开发者开放 API',
    summary: 'Meta Model API 可以 0.01 美元生成、编辑和组合图像，并先规划版面再绘制。',
  ...
  },
  {
    ...
    summary: '新适配器可做端到端加密的一对一与群聊机器人，并自动处理密钥与签名。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    summary: '在 QuickJS 沙箱执行不可信 TypeScript，经宿主函数中断以等待鉴权或人工批准。',
    source: 'Vercel Blog',
  ...
  },
  {
    ...
    summary: '脚手架新增 nub 包管理器，并在生成项目中提示实验性 React Compiler。',
    source: 'Vite GitHub',
  ...
  },
  {
    ...
    summary: 'Vercel 用类型取代 Sensitive 开关，Secret 保存后不可回看，并可用 CLI 指定。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-24',
    category: '后端',
    title: 'Bun 运行时支持大函数与长时',
    summary: 'Vercel 上 Bun 函数包可达 5GB，最长运行 30 分钟，此前仅 Node 与 Python 可用。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-21',
    category: 'AI',
    title: 'Mythos 5 进入更多防御工具',
    summary: 'Claude Security 可用 Mythos 5 扫描漏洞，并计划接入合作方防御产品。',
    source: 'Claude Blog',
  ...
  },
  {
    ...
    summary: 'Python 可发布与消费队列消息，并与 Next.js 生产者跨运行时扇出。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-19',
    category: 'AI',
    title: 'Vercel Agent 登陆 Slack 公测',
    summary: 'Pro 与企业团队可在频道里点名 Agent 查日志、提 PR，变更须经计划批准。',
    source: 'Vercel Blog',
  ...
  },
  {
    ...
    summary: '新增 MultiVectorEncoder 支持 ColBERT 式多向量检索，并升至 transformers v5。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    summary: '函数用 OIDC 身份签名，私钥留在托管 KMS，校验方只读公钥与标准 JWKS。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    summary: 'Foundry 上 Azure 托管部署现支持结构化输出、网页搜索抓取、MCP 与工具搜索。',
