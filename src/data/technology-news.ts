...
export const technologyNews: TechnologyNewsItem[] = [
  {
    ...
    summary: '可配置可选 MCP 发现宽限，扩展能改写工具结果，并修复远程沙箱与权限回退。',
  ...
  },
  {
    date: '2026-08-28',
    category: 'AI',
    title: 'OpenAI发布Rosalind科研工作台',
    summary: 'ChatGPT应用可试用生命科学工作台，串联结构、测序与实验工具并保留证据链。',
  ...
  },
  {
    date: '2026-08-28',
    category: 'AI',
    title: '腾讯开源Hy4 preview大模型',
    summary: '770B总参、49B激活、超百万上下文，面向编程、办公与科研，并开放权重与API。',
    source: 'Tencent',
  ...
  },
  {
    ...
    category: 'AI',
    title: '开放ASR评测纳入印地语',
    summary: 'Open ASR排行榜首次加入全球南方语言印地语，覆盖多口音与噪声条件。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    summary: 'Cloud企业版GA，用多智能体审查越权与业务逻辑漏洞，并先验证可利用再入库。',
    source: 'Sonar',
  ...
  },
  {
    ...
    summary: 'Meta Model API可生成、编辑与组合图像，按张计费，并支持锚定构图保持系列一致。',
  ...
  },
  {
    ...
    summary: '470M英语转写模型超12600倍实时，提供Apache与非商用版，适合边缘设备。',
    source: 'IBM Granite',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Gradio工作流可编排并部署',
    summary: 'gr.Workflow把步骤做成可运行画布，同一图既是界面也是REST，可一键发到Spaces。',
    source: 'Hugging Face',
  ...
  },
  {
    ...
    category: 'AI',
    title: '多向量嵌入微调指南发布',
    summary: '官方讲解用Sentence Transformers训练ColBERT式多向量编码器与检索接入。',
    source: 'Hugging Face',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Chat SDK新增XChat适配器',
    summary: '可建端到端加密的一对一和群聊机器人，自动处理密钥与签名，并支持主动私信。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-25',
    category: 'AI',
    title: 'Vercel发布Run SDK沙箱执行',
    summary: '在QuickJS中跑不可信JS/TS，用宿主函数暴露窄接口，并可中断等待审批后续跑。',
    source: 'Vercel Blog',
  ...
  },
  {
    ...
    summary: '脚手架新增nub，并更新React编译器说明与eslint-react文档链接。',
    source: 'Vite GitHub',
  ...
  },
  {
    date: '2026-08-24',
    category: '后端',
    title: '环境变量改为Config与Secret',
    summary: '仪表盘用类型取代Sensitive开关，Secret保存后不可回看，CLI可用--visibility。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    category: '后端',
    title: 'Bun运行时可跑大函数更久',
    summary: '包体积上限到5GB，最长时长30分钟，需Fluid；超800秒按函数在vercel.json配置。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-21',
    category: 'AI',
    title: 'Claude Mythos 5面向更多防御方',
    summary: '把Mythos 5网络安全能力开放给更多安全团队，用于威胁分析与防御工作流。',
    source: 'Claude Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: 'AI',
    title: 'Vercel Agent登陆Slack公测',
    summary: 'Pro与企业团队可在频道@Vercel查日志部署并提修复，改动先出计划再等人批准。',
    source: 'Vercel Blog',
  ...
  },
  {
    date: '2026-08-19',
    category: '后端',
    title: 'Vercel Python队列SDK进公测',
    summary: 'pip install vercel后可用装饰器订阅主题，把后台任务接到托管队列与重试。',
    source: 'Vercel Changelog',
  ...
  },
  {
    ...
    time: '13:46',
    category: 'AI',
    title: 'Sentence Transformers 6发布',
    summary: '新增多向量编码器，依赖升到transformers v5，并修正半精度计分与训练速度。',
  ...
  },
  {
    ...
    category: '后端',
    title: '函数可用KMS签发JWT',
    summary: 'Vercel KMS用托管非对称密钥签名，私钥不进环境变量，校验方只取公开JWKS。',
    source: 'Vercel Changelog',
  ...
  },
  {
    date: '2026-08-17',
    category: 'AI',
    title: 'Azure托管Claude新增五能力',
    summary: 'Foundry上Azure托管部署现支持结构化输出、网页搜索抓取、MCP与工具检索。',
