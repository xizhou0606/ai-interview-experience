...
export function parseRoute(): AppRoute {
  ...
  if (value === 'roadmap' || value === 'news' || value === 'technologies' || value === 'apis' || value === 'project-apis' || value === 'endpoints' || value === 'coverage' || value === 'projects' || value === 'patterns' || value === 'sources') {
    return { page: value }
  }
  return { page: 'home' }
}
