...
export function parseRoute(): AppRoute {
  ...
  if (value === 'news' || value === 'roadmap' || value === 'technologies' || value === 'apis' || value === 'project-apis' || value === 'endpoints' || value === 'coverage' || value === 'projects' || value === 'patterns' || value === 'sources') {
    return { page: value }
  }
  return { page: 'home' }
}
